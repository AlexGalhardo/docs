...
api: "GET https://api.docs.games.alexgalhardo.com/games/random"
...
fetch(`https://api.docs.games.alexgalhardo.com/games/random`, {
		method: "GET",
		headers: { 
...
```bash Using cURL
curl --location --request GET "https://api.docs.games.alexgalhardo.com/games/random" \
