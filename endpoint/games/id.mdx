...
api: "GET https://api.games.alexgalhardo.com/games/id/{game_id}"
...
fetch(`https://api.games.alexgalhardo.com/games/id/ffc6a795-09e0-4a3b-8da5-91279dca3b79`, {
		method: "GET",
		headers: { 
...
```bash Using cURL
curl --location --request GET "https://api.games.alexgalhardo.com/games/id/21a0471b-c19b-41e2-a2ea-a286528156f4" \
